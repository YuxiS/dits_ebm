...
def main():
    ...
    model = FrozenAutoencoderKL(ddconfig, 4,
                                 '/remote-home/yfsong/Diffusion/dit-dino/weights/autoencoder_kl.pth',
                                   scale_factor)
    # model = get_model(pretrained_path='/remote-home/yfsong/Diffusion/dit-dino/weights/autoencoder_kl.pth',
    #                   model_type='KL', stride=8
    #                   )
    ...
    path = '/remote-home/yfsong/Diffusion/dit-dino/wandb/run-20231104_083520-brzxhoz5/files/media/images'
