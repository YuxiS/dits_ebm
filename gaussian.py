...
class GaussianDiffusion:
    ...
    def __init__(
        ...
        betas = get_named_beta_schedule('linear', self.timesteps, beta_start, beta_end)
    ...
    def p_mean_variance(
        ...
        pred_xstart = process_xstart(self._predict_xstart_from_noise(x_t=x, t=t, eps=model_output))
        ...
        # }
    def _predict_xstart_from_noise(self, x_t, t, eps):
